...
import 'package:csslib/parser.dart' show parseSelectorGroup;
...
class StyledElement {
  ...
  bool matches(dom.Element element, String selector) {
    try {
      final selectorGroup = parseSelectorGroup(selector);
      return selectorGroup != null &&
          qs.SelectorEvaluator().matches(element, selectorGroup);
    } catch (_) {
      return false;
    }
  }
