...
class _LanguagesSettingState extends State<LanguagesSetting> {
  ...
  Widget _langListTile(String lang, {required Locale locale}) => ListTile(
    title: Text(lang, style: context.textTheme.bodyMedium),
    onTap: () => _setLocale(locale),
    dense: true,
    contentPadding: const EdgeInsets.symmetric(horizontal: 20),
    trailing: Transform.scale(scale: 0.8, child: Radio<Locale>(value: locale)),
  );
    ...
    return RadioGroup<Locale>(
      ...
      child: Column(
        children: [
          ...
          Divider(height: 1),
          ListTile(
            onTap: () => 'mailto:<tsacdop.app@gmail.com>?subject=Tsacdop localization project'
                .launchUrl,
            contentPadding: const EdgeInsets.only(left: 20, right: 20),
            dense: true,
            title: Align(
