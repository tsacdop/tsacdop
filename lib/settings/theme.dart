        ...
        body: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Text(s.settingsTheme),
              subtitle: Selector<SettingState, ThemeMode?>(
                selector: (_, setting) => setting.theme,
                builder: (_, theme, _) => Text(switch (theme) {
            ...
            Selector<SettingState, bool?>(
              ...
              builder: (_, data, _) => ListTile(
                ...
                //  leading: Icon(Icons.colorize),
                title: Text(s.useWallpaperTheme),
                      ...
                      child: GridView.count(
                        ...
                        children: <Widget>[
                          ...
                          ...color == Colors.red
                              ...
                              : color == Colors.yellow
                              ? _accentList(Colors.yellowAccent)
                              : color == Colors.lime
                              ? _accentList(Colors.limeAccent)
                              : color == Colors.lightGreen
                              ? _accentList(Colors.lightGreenAccent)
                              : color == Colors.green
                              ? _accentList(Colors.greenAccent)
                              : color == Colors.teal
                              ? _accentList(Colors.tealAccent)
                              : color == Colors.cyan
                              ? _accentList(Colors.cyanAccent)
