            ...
            children: [
              ...
              ListTile(
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => PopupMenuSetting()),
                ),
                  ...
                  builder: (_, data, _) => MyDropdownButton(
                    ...
                    items: <int>[0, 1, 2].map<DropdownMenuItem<int>>((e) {
                      return DropdownMenuItem<int>(
                        value: e,
                        child: Text(_getHeightString(PlayerHeight.values[e])),
                      );
                    }).toList(),
                ...
                FutureBuilder(
                  ...
                  builder: (context, snapshot) => ListTile(
                    ...
                    trailing: MyDropdownButton(
                      ...
                      onChanged: (dynamic value) => _saveSearchEngine(value),
                    ),
                  ),
                ),
              Divider(height: 1),
              ...
              Selector<SettingState, bool?>(
                ...
                builder: (_, data, _) {
                  return ListTile(
                    contentPadding: EdgeInsets.fromLTRB(70, 10, 10, 10),
                    onTap: () =>
                        context.read<SettingState>().openAllPodcastDefault =
                            !data,
