...
final List<BoxShadow> _customShadow = [
  ...
  BoxShadow(
    blurRadius: 8,
    offset: Offset(2, 2),
    color: Colors.grey[600]!.withValues(alpha: 0.4),
  ),
];
              ...
              Selector<AudioPlayerNotifier, bool?>(
                ...
                builder: (_, data, _) {
                  ...
                  return TextButton(
                    ...
                    onPressed: () =>
                        audio.setSkipSilence(skipSilence: !enabled),
                    child: Row(
                      children: [
                        Icon(
                          Icons.flash_on,
              ...
              Selector<AudioPlayerNotifier, bool?>(
                ...
                builder: (_, data, _) {
                  ...
                  return TextButton(
                    ...
                    onPressed: () =>
                        audio.setBoostVolume(boostVolume: !enabled),
                    child: Row(
                      children: [
                        Icon(
                          Icons.volume_up,
...
class SleepModeState extends State<SleepMode>
  ...
  Widget build(BuildContext context) {
    ...
    final colorTween = ColorTween(
      begin: context.accentColor.withAlpha(60),
      end: Colors.black,
    );
    var audio = Provider.of<AudioPlayerNotifier>(context, listen: false);
    return Selector<AudioPlayerNotifier, Tuple3<int, double, SleepTimerMode>>(
      ...
      builder: (_, data, _) {
        var fraction = data.item2 == 1
            ? 1.0
            : math.min(_animation.value * 2, 1.0);
        var move = data.item2 == 1
            ? 1.0
            : math.max(_animation.value * 2 - 1, 0.0);
              ...
              Padding(
                ...
                child: ButtonTheme(
                  ...
                  child: OutlinedButton(
                    ...
                    // highlightedBorderColor: Colors.green[700],
                    onPressed: () {
                      context.read<AudioPlayerNotifier>().seekTo(
