...
class _PlaylistHomeState extends State<PlaylistHome> {
  ...
  Widget build(BuildContext context) {
    final s = context.s;
    final openPlaylistByDefault = context
        .read<SettingState>()
        .openPlaylistDefault!;
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: PopScope<void>(
        canPop: !openPlaylistByDefault,
        onPopInvokedWithResult: (didPop, result) {
          if (!didPop && openPlaylistByDefault) {
        ...
        return queue == null
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isPlaying = data.item3 != null && data.item3 == episode;
                  return episode == null
                      ? Center()
                      : EpisodeCard(
                          episode,
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        ...
                        builder: (context) => PlaylistDetail(data[index]),
                      ),
                    ).then((value) => setState(() {}));
                  },
                  child: Padding(
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (_, index) {
                              if (index < queue.episodeList.length) {
                                return Image(
                                  image: queue.episodes[index]!.avatarImage,
                                );
                              }
                              return Center();
                            },
              ...
              if (index < data.length) {
                ...
                return ListTile(
                  onTap: () async {
                    await context.read<AudioPlayerNotifier>().updatePlaylist(
                      data[index],
                      updateEpisodes: true,
                    );
                    Navigator.push(
                  ...
                  trailing: TextButton(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Icon(Icons.play_arrow, color: context.accentColor),
                      ],
                    ),
                    onPressed: () {
                      context.read<AudioPlayerNotifier>().playlistLoad(
                        data[index],
                      );
                    },
                  ),
        ...
        actions: <Widget>[
          ...
          TextButton(
            ...
            onPressed: () async {
              if (_playlistName == '') {
                setState(() => _error = 0);
              } else if (context.read<AudioPlayerNotifier>().playlistExisted(
                _playlistName,
              )) {
                setState(() => _error = 1);
              } else {
