  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          IconButton(
            ...
            onPressed: () =>
                generalSheet(
                  ...
                  if (!context.read<AudioPlayerNotifier>().playlists.contains(
                    widget.playlist,
                  )) {
      ...
      body: Selector<AudioPlayerNotifier, List<Playlist>>(
        ...
        builder: (_, data, _) {
          final playlist = data.firstWhereOrNull((e) => e == widget.playlist);
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  ...
                  onPressed: () async {
                    context.read<AudioPlayerNotifier>().clearPlaylist(
                      widget.playlist,
                    );
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  ...
                  onPressed: () async {
                    context.read<AudioPlayerNotifier>().deletePlaylist(
                      widget.playlist,
                    );
                    Navigator.of(context).pop();
                  },
