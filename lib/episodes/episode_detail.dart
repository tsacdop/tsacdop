...
class _EpisodeDetailState extends State<EpisodeDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    final headerColor = widget.episodeItem!.cardColor(context);
    final statusBarIconBrightness =
        ThemeData.estimateBrightnessForColor(headerColor) == Brightness.dark
        ? Brightness.light
        : Brightness.dark;
    final systemUiOverlayStyle = SystemUiOverlayStyle(
      statusBarColor: Platform.isAndroid ? Colors.transparent : headerColor,
                    ...
                    headerSliverBuilder: (context, innerBoxScrolled) {
                      return <Widget>[
                        SliverAppBar(
                          ...
                          backgroundColor: widget.episodeItem!.cardColor(
                            context,
                          ),
                          floating: true,
                          pinned: true,
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  s.published(
                                    formateDate(widget.episodeItem!.pubDate!),
                                  ),
